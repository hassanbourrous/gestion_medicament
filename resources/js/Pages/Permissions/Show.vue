    ...
    <jig-layout>
        <template #header>
            ...
            >
                ...
                ><i class="fas fa-arrow-left"></i> Retour | Détails de Permission
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-permissions-form :model="model"></show-permissions-form>
            </div>
        </div>
...
<script>
    ...
    import ShowPermissionsForm from "./ShowForm.vue"
    export default {
        name: "ShowPermission",
        components: {
            InertiaButton,
