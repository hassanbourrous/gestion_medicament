<template>
    <jig-layout>
        <template #header>
            ...
            >
                <inertia-link
                    :href="route('admin.stock-statuses.index')"
                    class="text-2xl font-black text-white"
                ><i class="fas fa-arrow-left"></i> Retour | Détails de Stock Status
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-stock-statuses-form :model="model"></show-stock-statuses-form>
            </div>
        </div>
...
<script>
    ...
    import ShowStockStatusesForm from "./ShowForm.vue"
