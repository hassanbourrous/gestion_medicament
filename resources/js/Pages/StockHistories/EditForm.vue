<template>
    <form @submit.prevent="updateModel">
            ...
            <jet-input-error :message="form.errors.quantite" class="mt-2" />
                    ...
                    <infinite-select class="w-full" :per-page="15" :api-url="route('api.detainees.index')"
                    ...
                    <infinite-select class="w-full" :per-page="15" :api-url="route('api.stocks.index')"
                                     id="stock" name="stock"
                    ...
                    <infinite-select class="w-full" :per-page="15" :api-url="route('api.users.index')"
                                     id="user" name="user"
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            async updateModel() {
                this.form.put(this.route('admin.stock-histories.update',this.form.id),
                    {
                        onSuccess: res => {
