    ...
    <jig-layout>
        ...
        <div class="flex flex-wrap px-4">
            <div class="z-10 flex-auto max-w-2xl p-4 mx-auto bg-white md:rounded-md md:shadow-md">
                <create-stock-histories-form @success="onSuccess" @error="onError"/>
            </div>
        </div>
    </jig-layout>
</template>
...
<script>
    ...
    import CreateStockHistoriesForm from "./CreateForm.vue";
    import DisplayMixin from "@/Mixins/DisplayMixin.js";
    import { defineComponent } from "vue";

    export default defineComponent({
        name: "CreateStockHistories",
        components: {
            InertiaButton,
            JigLayout,
            CreateStockHistoriesForm,
        },
        data() {
            return {}
        },
