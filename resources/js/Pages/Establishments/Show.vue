    ...
    <jig-layout>
        <template #header>
            ...
            >
                ...
                ><i class="fas fa-arrow-left"></i> Retour | Détails de Établissement
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-establishments-form :model="model"></show-establishments-form>
            </div>
        </div>
...
<script>
    ...
    import ShowEstablishmentsForm from "./ShowForm.vue"
