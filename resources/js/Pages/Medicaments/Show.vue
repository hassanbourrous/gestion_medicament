<template>
    <jig-layout>
        <template #header>
            ...
            >
                <inertia-link
                    :href="route('admin.medicaments.index')"
                    class="text-2xl font-black text-white"
                ><i class="fas fa-arrow-left"></i> Retour | Détails de Médicament
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-medicaments-form :model="model"></show-medicaments-form>
            </div>
        </div>
...
<script>
    ...
    import ShowMedicamentsForm from "./ShowForm.vue"
