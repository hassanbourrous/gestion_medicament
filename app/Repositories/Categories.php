...
class Categories
{
    ...
    public static function init(Category $model): Categories
    {
        $instance = new self;
    ...
    public static function store(object $data): Category
    {
        $model = new Category((array) $data);
                // Save Relationships
    ...
    public function update(object $data): Category
    {
    ...
    public static function dt($query) {
        return DataTables::of($query)
            ->editColumn('actions', function (Category $model) {
                $actions = '';
