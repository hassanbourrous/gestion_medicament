...
class FillPermissionsForRegions extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRegions constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'List All Regions' => 'regions.index',
            'Create New Regions' => 'regions.create',
            'View Any Region' => 'regions.show',
            'Edit or Update a Single Region' => 'regions.edit',
            'Delete Regions' => 'regions.delete',
        ]);
