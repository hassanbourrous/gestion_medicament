...
class FillPermissionsForStockStatuses extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStockStatuses constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Stock Status Module' => 'stock-statuses',
            'List All Stock Status' => 'stock-statuses.index',
            'Create New Stock Status' => 'stock-statuses.create',
            'View Any Stock Status' => 'stock-statuses.show',
            'Edit or Update a Single Stock Status' => 'stock-statuses.edit',
            'Delete Stock Status' => 'stock-statuses.delete',
        ]);
