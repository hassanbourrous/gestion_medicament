...
class FillPermissionsForCategories extends Migration
{
    ...
    /**
     * FillPermissionsForCategories constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'List All Category' => 'categories.index',
            'Create New Category' => 'categories.create',
            'View Any Category' => 'categories.show',
            'Edit or Update a Single Category' => 'categories.edit',
