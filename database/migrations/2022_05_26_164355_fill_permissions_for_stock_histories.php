...
class FillPermissionsForStockHistories extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStockHistories constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Stock History Module' => 'stock-histories',
            'List All Stock History' => 'stock-histories.index',
            'Create New Stock History' => 'stock-histories.create',
            'View Any Stock History' => 'stock-histories.show',
            'Edit or Update a Single Stock History' => 'stock-histories.edit',
            'Delete Stock History' => 'stock-histories.delete',
        ]);
