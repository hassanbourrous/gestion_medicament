...
class FillPermissionsForDetainees extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDetainees constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Detainees Module' => 'detainees',
            'List All Detainees' => 'detainees.index',
            'Create New Detainees' => 'detainees.create',
            'View Any Detainee' => 'detainees.show',
            'Edit or Update a Single Detainee' => 'detainees.edit',
            'Delete Detainees' => 'detainees.delete',
        ]);
