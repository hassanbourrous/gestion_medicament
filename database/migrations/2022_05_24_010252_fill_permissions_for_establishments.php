...
class FillPermissionsForEstablishments extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEstablishments constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Establishments Module' => 'establishments',
            'List All Establishments' => 'establishments.index',
            'Create New Establishments' => 'establishments.create',
            'View Any Establishment' => 'establishments.show',
            'Edit or Update a Single Establishment' => 'establishments.edit',
            'Delete Establishments' => 'establishments.delete',
        ]);
