...
class FillPermissionsForMedicaments extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMedicaments constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Medicaments Module' => 'medicaments',
            'List All Medicaments' => 'medicaments.index',
            'Create New Medicaments' => 'medicaments.create',
            'View Any Medicament' => 'medicaments.show',
            'Edit or Update a Single Medicament' => 'medicaments.edit',
            'Delete Medicaments' => 'medicaments.delete',
        ]);
